...
- MongoDB модели (User, Boss, Clan, Message)
- JWT аутентификация
- REST API (auth, user, boss, clan)
...
- Тестирование босс-боев через Socket.io

📋 **СЛЕДУЮЩИЕ ШАГИ:**

- Настройка ESLint/Prettier
- Добавление больше игровых механик
- Создание системы предметов
